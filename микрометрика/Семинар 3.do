...
* от количества детей, возраста и брака, то есть sigma=exp(g1*age+g2*children). Нулевая гипотеза об отсутствии гетероскедастичности отвергается.
